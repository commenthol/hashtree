...
;(function (exports) {
  ...
  hashTree.get = function (obj, keys) {
    ...
    for (i in keys) {
      if (typeof tmp === 'object' && hasOwnProperty.call(tmp, keys[i])) {
        tmp = tmp[keys[i]]
      } else {
        tmp = undefined
        break
  ...
  hashTree.diff = function (obj1, obj2, keys, diff1, diff2) {
    ...
    if (obj1 && obj2) {
      for (i in obj1) {
        // istanbul ignore else
        if (hasOwnProperty.call(obj1, i)) {
          if (hasOwnProperty.call(obj2, i)) {
      ...
      for (i in obj2) {
        if (hasOwnProperty.call(obj2, i) && !hasOwnProperty.call(obj1, i)) {
          // only in obj2
          keys.push(i)
          hashTree.set(diff2, keys, obj2[i])
          keys.pop()
